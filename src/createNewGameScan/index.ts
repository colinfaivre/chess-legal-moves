...
export function createNewGameScan(gameState: IGameState): IScan {
    ...
    if (board.whiteKnights) scan.legalMoves.push(...generate.knightsMoves(board, gameState.hasToPlay));
    ...
    if (board.whiteKing) scan.legalMoves.push(...generate.kingMoves(board, gameState.hasToPlay));
